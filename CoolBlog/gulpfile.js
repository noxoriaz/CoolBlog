...
// TODO: fix aliasify, not working at the moment
...
gulp.task('build', function () {
    ...
    folders.map(function (folder) {
        compileJS(scriptsPath + "//" + folder + "//main.js", "Static//App//" + folder);
    });
});
...
gulp.task('default', function () {
    ...
    gutil.log(folders);
    folders.map(function (folder) {
        watchFolder(scriptsPath + "//" + folder + "//main.js", "Static//App//" + folder);
    });
